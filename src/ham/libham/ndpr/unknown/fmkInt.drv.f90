...
program test_ndp
   ...
   double precision :: ct0, ct1 !, getFmkIntegral
   ...
   if (init()) then
        ...
        do 
           ...
           do m1 = 0, mmax
              do m2 = 0, mmax
                 k1 = 1;  k2 = 1
                 sphi = getFmkIntegral(m1,k1,m2, k2)
                 write(*,10) m1,k1,m2, k2, sPhi
...
10 Format('m1=',I4,1x,'k1=',I2,1x,'m2=',I4,1x,'k2=',I2,1x,'<Phi>:',F10.7)
