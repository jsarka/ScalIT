...
program test_simplemin
   ...
   double precision, dimension(N) :: range
   double precision :: fret
   
   integer :: i, num, simpleMin
   ...
   num = simpleMin(N, NP, P, Xi, range, ftol, func, fret)
