...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H1X_XYZ_DX_Seq(NIN, NOUT, BLK, H1, X, Y)
      implicit none
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H1TX_XYZ_DX_Seq(NIN, NOUT, BLK, H1, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
      double precision,intent(IN)  :: H1(NOUT,NOUT)  
      double complex,intent(IN)  :: X(NIN,NOUT,BLK)  
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H2X_DEP_DX_Seq(NIN, NOUT, BLK, H1, Depx, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
      double precision,intent(IN)  :: H1(NOUT,NOUT)       
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H2TX_DEP_DX_Seq(NIN, NOUT, BLK, H1, Depx, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
      double precision,intent(IN)  :: H1(NOUT,NOUT)       
      double precision,intent(IN)  :: DepX(NIN)   
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H3X_Out_DX_Seq(NIN, NOUT, BLK, outH, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H3TX_Out_DX_Seq(NIN, NOUT, BLK, outH, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
      double precision,intent(IN)  :: outH(NIN,NOUT,NOUT)  
      double complex,intent(IN)  :: X(NIN,NOUT,BLK)  
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine VX_DX_Seq(NIN, NOUT, BLK, VOUT, X)
      implicit none      
      integer, intent(IN) :: NIN, NOUT, BLK
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine VTX_DX_Seq(NIN, NOUT, BLK, VOUT, X)
      implicit none      
      integer, intent(IN) :: NIN, NOUT, BLK
      double precision, intent(IN) :: Vout(NOUT,NOUT,BLK)
      double complex, intent(INOUT) :: X(NIN,NOUT, BLK)
