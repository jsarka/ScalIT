...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H1X_XYZ_CX_Seq(NIN, NOUT, BLK, H1, X, Y)
      implicit none
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H1TX_XYZ_CX_Seq(NIN, NOUT, BLK, H1, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
      double complex,intent(IN)  :: H1(NOUT,NOUT)  
      double complex,intent(IN)  :: X(NIN,NOUT,BLK)  
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H2X_DEP_CX_Seq(NIN, NOUT, BLK, H1, Depx, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
      double complex,intent(IN)  :: H1(NOUT,NOUT)       
      double complex,intent(IN)  :: DepX(NIN)   
      double complex,intent(IN)  :: X(NIN,NOUT,BLK)  
      double complex,intent(OUT) :: Y(NIN,NOUT,BLK)
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H2TX_DEP_CX_Seq(NIN, NOUT, BLK, H1, Depx, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
      double complex,intent(IN)  :: H1(NOUT,NOUT)       
      double complex,intent(IN)  :: DepX(NIN)   
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H3X_Out_CX_Seq(NIN, NOUT, BLK, outH, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
      double complex,intent(IN)  :: outH(NIN,NOUT,NOUT)  
      double complex,intent(IN)  :: X(NIN,NOUT,BLK)  
      double complex,intent(OUT) :: Y(NIN,NOUT,BLK)
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine H3TX_Out_CX_Seq(NIN, NOUT, BLK, outH, X, Y)
      implicit none
      integer,intent(IN) :: NIN, NOUT, BLK
      double complex,intent(IN)  :: outH(NIN,NOUT,NOUT)  
      double complex,intent(IN)  :: X(NIN,NOUT,BLK)  
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine VX_CX_Seq(NIN, NOUT, BLK, VOUT, X)
      implicit none      
      integer, intent(IN) :: NIN, NOUT, BLK
      double complex,intent(IN)    :: VOUT(NOUT,NOUT,BLK) 
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
 subroutine VTX_CX_Seq(NIN, NOUT, BLK, VOUT, X)
      implicit none      
      integer, intent(IN) :: NIN, NOUT, BLK
      double complex, intent(IN) :: Vout(NOUT,NOUT,BLK)
      double complex, intent(INOUT) :: X(NIN,NOUT, BLK)
