...
!CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
  ...
  double precision function MJACOBI_CX_MPI(COMM,P,Q,NOUT,NIN,HOUT,IERR)
      implicit none
      include 'mpif.h'
...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      LOCABC(1) = dble(dot_product(ODG(1:NIN),ODG(1:NIN)))
      LOCABC(2) = 2.0D0 * dble(dot_product(ODG(1:NIN),DDG(1:NIN)))
      LOCABC(3) = dble(dot_product(DDG(1:NIN), DDG(1:NIN)))
