...
!     if(myid == 1)  print *, 'X for ID=', myID, x
    ...
    case (0)
     ...
     case(1)      
      if(lanConv1_MPI(MYID, ROOTID, E0, ETOL, N1, X, EIGNUM, MAX_NUM,  &
     ...
     case(2)
      if(lanConv2_MPI(MYID, ROOTID,E0, ETOL, N1, X, EIGNUM, MAX_NUM,  &
                       HMULT, EIG, RES)>0) THEN
          IF (MYID==ROOTID) THEN
              print *
              print *, ' Performing Lanczos using Faster Convergent Criterion'
     ...
     case(3)
      if(lanConv51_MPI( MYID, ROOTID,E0, ETOL, N1, X, EIGNUM, MAX_NUM,  &
                       HMULT, EIG, RES)>0) THEN
         IF (MYID==ROOTID) THEN
              print *
    ...
    case (4)
      if(lanConv52_MPI(MYID, ROOTID, E0, ETOL, N1, X, EIGNUM, MAX_NUM,  &
                       HMULT, EIG, RES)>0) THEN
         IF (MYID==ROOTID) THEN
            print *
